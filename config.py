...
class Channel:
    def __init__(self, id, music_channels, music_intensities, ambient_track, track_duration, track_count, fade_in_sec, fade_out_sec
                 ...
                 , diffusion_strength, fps, seed, video_height, video_width, color_coherence, diffusion_cadence
                 , animation_mode, sd_model_name, sd_model_hash, transform_center_y, translation_x, translation_y, translation_z, rotation_3d_x, rotation_3d_y, rotation_3d_z):
        self.id = id
        ...
        self.transform_center_y = transform_center_y
...
def get_channel(id):
    ...
    if id == 'zenscend':
        ...
        return Channel(
            ...
            #  video prompting
            positive_end='black background, 3D, colorful, swirls, abstract, extremely detailed CG unity 8k wallpaper, <lora:psych-face:0.8>',
            negative_end='(blurry:2.0),(worst quality:2.0),(monochrome:2.0)',
        ...
        return Channel(
            ...
            negative_end='monochrome, (blurry:2.0), (worst quality:2.0), nsfw, boobs',
